		...
		<div class="col-sm-6 col-md-offset-3">
			<form action="memberjoinpro.do" method="post" role="form"
				...
				<div class="form-group">
					...
					<label for="id">상점을소개해주세요</label> <input type="text"
						class="form-control" id="mem_id" name="상점을 간단히 소개해주세요"
						placeholder="ID">
				...
				<div>
					<input type="text" id="sample6_postcode" placeholder="출고지 우편번호"
				...
				<div>
					<input type="text" id="sample6_detailAddress" placeholder="상세주소"
						...
						id="sample6_extraAddress" placeholder="참고항목 ex)서창동,만수동"
						class="form-control"><br>
				</div>
				<div class="form-group text-center">
					<button type="submit" class="btn btn-primary">개설하기</button>
					<button type="submit" class="btn btn-primary"
						href="/adaco/artist/artistPage">취소하기</button>
				</div>
			</form>
		</div>
	</article>
