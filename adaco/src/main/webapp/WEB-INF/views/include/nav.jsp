					...
					<!-- 				</li> -->
							...
							<i class="fas fa-user"></i> 마이페이지</a></li>&emsp;
								...
								<ul class="dropdown-menu" role="menu"
									...
									<li><a href="#" style="text-decoration: none;"><i class="fas fa-exclamation"></i>
											공지사항</a></li>
									<li class="#"></li>
									<li><a href="#" style="text-decoration: none;"><i class="fas fa-question"></i>
											자주 묻는 질문</a></li>
									<li><a href="#" style="text-decoration: none;"><i class="far fa-paper-plane"></i>
											메일로 문의</a></li>
								</ul>
								</li>
			</sec:authorize>
